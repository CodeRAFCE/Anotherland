...
const Section02 = () => {
	return (
		<MaxWidthWrapper>
			<div className="relative flex flex-col justify-center space-y-12 max-w-xs md:max-w-3xl mx-auto pt-[137px] md:pt-[300px] font-maisonMono">
				<div className="text-center md:text-[24px] tracking-[-0.48px] hidden md:block">
				...
				{/* MOBILE SCREEN */}
				<div className="text-center text-[14.6px] tracking-[-0.3px] block md:hidden">
