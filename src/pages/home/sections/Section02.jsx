...
const Section02 = () => {
	return (
		<MaxWidthWrapper>
			<div className="relative flex flex-col justify-center space-y-12 max-w-[21rem] md:max-w-3xl mx-auto pt-[100px] md:pt-[300px] font-maisonMono">
				<div className="text-center md:text-[24px] leading-7 tracking-[-0.48px] hidden md:block">
